...
java -Xms256m -Xmx512m -server -Xloggc:../logs/gc.log -verbose:gc -XX:+PrintGCDetails -XX:+HeapDumpOnOutOfMemoryError -XX:HeapDumpPath=../logs -Dspring.config.location=../config/application.properties,../config/argus-app.properties,../config/argus-cred.properties -jar ../lib/argus-automation-tma-0.0.1-SNAPSHOT-exec.jar